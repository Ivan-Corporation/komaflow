...
export class Koma__eip712DomainResult {
  value0: Bytes;
  value1: string;
  value2: string;
  value3: BigInt;
...
export class Koma extends ethereum.SmartContract {
  static bind(address: Address): Koma {
    return new Koma("Koma", address);
  }
  ...
  eip712Domain(): Koma__eip712DomainResult {
    let result = super.call(
      "eip712Domain",
    ...
    return new Koma__eip712DomainResult(
      result[0].toBytes(),
      result[1].toString(),
      result[2].toString(),
      result[3].toBigInt(),
  ...
  try_eip712Domain(): ethereum.CallResult<Koma__eip712DomainResult> {
    let result = super.tryCall(
      "eip712Domain",
      "eip712Domain():(bytes1,string,string,uint256,address,bytes32,uint256[])",
      [],
...
export class __Blacklistable_initCall extends ethereum.Call {
  get inputs(): __Blacklistable_initCall__Inputs {
    return new __Blacklistable_initCall__Inputs(this);
  }

  get outputs(): __Blacklistable_initCall__Outputs {
    return new __Blacklistable_initCall__Outputs(this);
  }
}

export class __Blacklistable_initCall__Inputs {
  _call: __Blacklistable_initCall;

  constructor(call: __Blacklistable_initCall) {
    this._call = call;
  }
...
export class __Blacklistable_initCall__Outputs {
  _call: __Blacklistable_initCall;
